                ...
                <Swiper 
                    ...
                    <View style={styles.slide}>
                        <View style={styles.card}>
                            ...
                            <TextInput keyboardType="numeric" ref="number" autoFocus={true} value={this.state.number} onChangeText={(number) => this.setState({number})} style={{width:(Dimensions.get('window').width-70)}}/>
                        </View>
                    </View>
                    <View style={styles.slide}>
                        <View style={styles.card}>
                    ...
                    <View style={styles.slide}>
                        <View style={styles.card}>
                            ...
                            <TextInput keyboardType="numeric" ref="expiry" value={this.state.expiry} onChangeText={(expiry) => this.setState({expiry})} style={{width:(Dimensions.get('window').width-70)}}/>
                        </View>
                    </View>
                    <View style={styles.slide}>
                        <View style={styles.card}>
                            <Text style={styles.textCvc}>CVV/CVC NUMBER</Text>
                            <TextInput keyboardType="numeric" ref="cvc" value={this.state.cvc} onChangeText={(cvc) => this.setState({cvc})} style={{width:(Dimensions.get('window').width-70)}}/>
                        </View>
                    </View>             
                </Swiper>
