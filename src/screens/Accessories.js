      ...
      <ScrollView style={{flex:1}}>
        ...
        <View style={{flex:1,backgroundColor: this.state.background,width:"100%"}}>
            <View style={{width:"100%",alignItems: 'center',marginTop:10,marginBottom:10}}>
                <View style={{width:"90%"}}>
                    <ListView navigation={(val) => this.props.navigation.navigation.navigate("Item",val)} back={this.state.color} textColor={this.state.text} Name="Crocodile Leather Shoes" Price="59.99" Image={Shoes} />
                </View>
                <View style={{width:"90%"}}>
